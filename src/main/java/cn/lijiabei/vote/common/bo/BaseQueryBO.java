package cn.lijiabei.vote.common.bo;
...
public class BaseQueryBO implements Serializable {
	...
	private static final long serialVersionUID = -5440505873728089767L;

	private int pageSize = 20;// 每页数量
	private int pageNo = 1;// 页码
	private int record = 0;// 结果总记录数
	private boolean isPage = true;// 是否进行分页
